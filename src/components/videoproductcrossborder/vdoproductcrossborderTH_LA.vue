    ...
    <div class="content">
      <div class="glass-card">
        <div class="topcontainer">
          <h1 ref="titleRef">
            ໄທ
            <img src="https://flagcdn.com/th.svg" alt="Thailand Flag" />
            ສະແກນຊຳລະ ລາວ
            <img src="https://flagcdn.com/la.svg" alt="Laos Flag" />:
            ນັກທ່ອງທ່ຽວໄທຊຳລະຢູ່ລາວ
          </h1>
        </div>
        ...
        <div class="centercontainer">
          ...
          <div class="logomember">
            <div class="logo-row">
              <img src="/logoallmember/retangle_scale/krungsi.jpeg" alt="Krungsi" />
        ...
        <div class="bottomcontainer">
          ...
          <div class="logomember">
            ...
            <div class="logo-row" style="margin-top: 10px">
              ...
              <img src="/logoallmember/retangle_scale/kbank.jpg" alt="KBank Laos" />
...
.content {
  ...
  width: 90%;
  max-width: 1200px;
  min-height: 60vh; /* let content grow naturally */
  display: flex;
...
/* (QR styles kept in case you add one later) */
.imgqrpayment {
  width: 30%;
  max-width: 260px;
  margin: 20px auto 0;
...
const subtitleRef = ref(null); // kept for future use if you add a subtitle
const buttonRef = ref(null);   // kept for future use if you add a button

onMounted(() => {
  // Safely animate only if refs exist
  if (titleRef.value) {
