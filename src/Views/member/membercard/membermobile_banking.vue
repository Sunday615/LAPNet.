...
const filterOptions = [
    ...
    {
        label: 'ໂອນເງິນຂ້າມທະນາຄານເທິງມືຖືນຳໃຊ້ເລກບັນຊີ',
        value: 'transfer-by-number',
    },
    {
        label: 'ໂອນເງິນຂ້າມທະນາຄານຜ່ານ QR Code',
        value: 'transfer-by-qrcode',
    },
    {
        label: 'ຊຳລະຄ່າສິນຄ້າ ແລະ ບໍລິການ ໂດຍການສະແກນ QR Code',
        value: 'payment-by-qrcode',
    },
];
...
const members = ref([
    {
        ...
        filters: ['transfer-by-number', 'transfer-by-qrcode', 'payment-by-qrcode'],
    },
    {
    ...
    },
    {
        ...
        title: "ທະນາຄານ ລາວຝຣັ່ງ ຈຳກັດ (BFL)",
    ...
    {
        image: "/logoallmember/circle_scale/mb.png",
    ...
    },
    {
        ...
        title: "ບໍລິສັດ ລາວ ໂມບາຍມັນນີ ຈໍາກັດຜູ້ດຽວ (LMM)",
        subtitle: "MmoneyX ",
    ...
    {
        image: "/logoallmember/circle_scale/umoney.png",
        title: "ບໍລິສັດ ສະຕາ ຟິນເທັກ ຈຳກັດຜູ້ດຽວ (SFT)",
        subtitle: "Umoney",
...
// real filter values (exclude "all")
...
const filteredMembers = computed(() => {
    ...
    return members.value.filter((m) => {
        ...
        // no filters selected → show all that match search
            ...
            <div class="filterPanel">
                ...
                <div class="filterGroup">
                    <div class="filterGroupHeader">
                        <span class="filterGroupTitle">
                            ຄົ້ນໝວດໝູ່ທະນາຄານສະມາຊິກ
                        </span>
