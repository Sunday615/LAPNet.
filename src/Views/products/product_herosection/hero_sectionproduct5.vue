        ...
        <div class="hero-inner">
            ...
            <div class="hero-left">
                ...
                <p class="hero-subtitle">
                   ...
                   <router-link :to="{ path: '/products_service/allproduct', query: { id: 5 } }">
...
const props = defineProps({
    // use this as your video URL
    imageSrc: {
        type: String,
        default: "/videos/productvideo/product4-mockup.mp4",
    },
});
...
onMounted(() => {
    ctx = gsap.context(() => {
        ...
        // ✨ small idle floating animation on mockup frame
        ...
        // ✨ GSAP light sweep on image (very visible)
        gsap.fromTo(
            ".image-sweep",
            { x: "-140%", opacity: 0 },
            {
...
.mockup-inner {
    ...
    background: #000; /* in case video has transparency/edges */
}
...
/* ✨ light sweep over image (TOP layer) */
.image-sweep {
    position: absolute;
    top: -20%;
    left: -40%;
