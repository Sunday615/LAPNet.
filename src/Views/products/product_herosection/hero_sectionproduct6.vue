        ...
        <div class="hero-inner">
            ...
            <div class="hero-left">
                ...
                <p class="hero-subtitle">
                    ບໍລິສັດ LAPNet ໄດ້ຕໍ່ຍອດການພັດທະນາລະບົບຊຳລະຂ້າມທະນາຄານເທິງມືຖື
                ...
                <router-link :to="{ path: '/products_service/allproduct', query: { id: 6 } }">
...
const props = defineProps({
    ...
    imageSrc: {
        type: String,
        default:
            "/product/product6/prodcut6.1.png",
    },
});
